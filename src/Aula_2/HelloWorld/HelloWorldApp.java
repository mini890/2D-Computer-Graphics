...
public class HelloWorldApp {
    public static void main(String[] args) {
        ...
        //Apesar de Ponto3D n�o ter definido em si o X e Y, vai buscar a partir do Ponto2D
        p.setX(1);
        p.setY(2);
        p.setZ(3);
        ...
        //Declara��o de 1 Array com 3 Posi��es
        ...
        //Ciclo for que percorre o array autom�ticamente
        for (Ponto3D pTemp: pa) {
        	//Format permite imprimir com um determinado formato, %d para inteiro, %f para float %1.2f para 2 casas d�cimais
        	//e determinar � frente o que vai ser impresso por ordem de escrita 
        	System.out.format("Ponto (%d,%d,%d)\n", pTemp.getX(), pTemp.getY(), pTemp.getZ());
        }
        
        //ArrayList � um array din�mico, sem limite
