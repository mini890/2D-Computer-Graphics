...
public class Carro {
	...
	public Carro() {
		this.xinicial = 0;
		this.yinicial = 0;
		roda1 = new RodaPneu(8, 17, 5);
		roda2 = new RodaAros(8, 17);
	}
	...
	public void trocaParaRodaAros() {
		RodaAros a = new RodaAros(8, 17);
		RodaAros b = new RodaAros(8, 17);
	...
	public void trocaParaRodaPneu() {
		RodaPneu a = new RodaPneu(8, 17, 5); 
		RodaPneu b = new RodaPneu(8, 17, 5);
